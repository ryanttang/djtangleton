...
export default function CRTImage(
  ...
  return (
    <div className="relative w-full h-full overflow-hidden rounded-lg border-4 border-cyan-500 bg-black">
      <Image src={src} alt={alt} fill className="object-cover contrast-125 brightness-90" />
